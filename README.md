...
- 🎯 Entry points to execute your program using `python -m <opendigger_pycli>` or `$ opendigger_pycli` with basic CLI argument parsing.
...
```py
from opendigger_pycli import BaseClass
from opendigger_pycli import base_function
